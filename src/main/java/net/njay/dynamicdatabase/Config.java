...
import net.njay.dynamicdatabase.util.config.ConfigAnnotation;
import net.njay.dynamicdatabase.util.config.ConfigStructure;
...
public class Config {
    ...
    /**
     * Same operation as {@link Config#get(String)}, just with a default value.
     */
    @SuppressWarnings("unchecked")
