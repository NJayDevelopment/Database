package net.njay.dynamicdatabase.serverinterconnect;
...
import net.njay.dynamicdatabase.serverinterconnect.packets.DynamicDBPacket;
...
public class ConnectionManager {
    ...
    public static void registerPackets() {
        Reflections reflections = new Reflections("net.njay.dynamicdatabase.serverinterconnect.packets");
