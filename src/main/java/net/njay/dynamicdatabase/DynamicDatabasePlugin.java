...
import net.njay.dynamicdatabase.commands.AdminChatCommand;
import net.njay.dynamicdatabase.commands.PlayerCommands;
import net.njay.dynamicdatabase.commands.PunishmentCommands;
...
import net.njay.dynamicdatabase.listeners.ElevationListener;
import net.njay.dynamicdatabase.listeners.PermissionsListener;
import net.njay.dynamicdatabase.listeners.SessionListener;
import net.njay.dynamicdatabase.listeners.UserListener;
import net.njay.dynamicdatabase.module.loader.ExternalModuleLoader;
import net.njay.dynamicdatabase.serverinterconnect.ConnectionManager;
import net.njay.dynamicdatabase.tasks.core.SaveTask;
import net.njay.dynamicdatabase.util.ExceptionHandler;
import net.njay.dynamicdatabase.util.LanguageFile;
...
public class DynamicDatabasePlugin extends JavaPlugin {
    ...
    private void setupMorphia(MongoClient mongo) {
        ...
        morphia.mapPackage("net.njay.dynamicdatabase.documents", true);
    ...
    private void setupDataStores(MongoClient mongo, Morphia morphia) {
        Reflections reflections = new Reflections("net.njay.dynamicdatabase");
    ...
    private void registerModules(MongoClient mongo, Morphia morphia){
        ...
        loader = new ExternalModuleLoader(morphia, mongo, modulesFolder);
        loader.load();
    }
